 ...
 * @author Goutam
 */
public class marathonLogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DBPool.log("Marathon Login Req param :: \n" + requestString);
            JSONObject jsonReq = new JSONObject(requestString);
            
            DBOperation db = new DBOperation();
            JSONObject result = new JSONObject();
            db.MarathonLogin(jsonReq.getString("email"),jsonReq.getString("password"),result);
            result.write(out);
