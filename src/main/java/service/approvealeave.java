 ...
 * @author Goutam
 */
public class approvealeave extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DBPool.log("approvearequest Req param :: \n" + requestString);
            JSONObject jsonReq = new JSONObject(requestString);

            DBOperation db = new DBOperation();
            JSONObject result = new JSONObject();
            db.approvealeave(jsonReq.getString("sl"),jsonReq.getString("status"), result);
            result.write(out);
