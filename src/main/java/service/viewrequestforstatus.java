 ...
 * @author Goutam
 */
public class viewrequestforstatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            DBPool.log("approvedleaverequest Req param :: \n");
            JSONObject jsonReq = new JSONObject(requestString);
            
            DBOperation db = new DBOperation();
            JSONObject result = new JSONObject();
            db.approvedrequest(result,Integer.parseInt(jsonReq.getString("status")));
            result.write(out);
